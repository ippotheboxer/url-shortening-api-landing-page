...
const InputURL: React.FC = () => {
  return (
    <Wrapper>
        <div className='mx-4 md:mx-0 flex flex-col md:flex-row items-center rounded-md p-6 md:p-8 bg-dark-violet bg-[url(assets/images/bg-shorten-mobile.svg)] md:bg-[url(assets/images/bg-shorten-desktop.svg)] bg-center bg-cover'>
